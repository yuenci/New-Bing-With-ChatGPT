...
function changeHearderStyle() {
    ...
    logo.attr("src", `${path}/microsoft-white.png`);
...
function addSearchContent() {
    let content = `
        <div id="search-input-container">
            <img id="search-input-engine"  src="${path}/bing.png" />
        ...
        <div id="search-engines-container">
            <div class="search-engine">
                <img class="search-engine-icon" src="${path}/bing.png" />
            </div>
            <div class="search-engine">
                <img class="search-engine-icon"  src="${path}/google.png"   />
            </div>
            <div class="search-engine">
                <img class="search-engine-icon" src="${path}/baidu.png" />
            </div>
        </div>
    `;
